...
def create_correlations(parent, width, height):
    ...
    correlations_title = tk.Label(master = top_frame, text = 'Correlations', font = "Calibri 30")
    correlations_title.configure(bg = win_color, fg = 'white')
    correlations_title.pack_propagate(False)
    correlations_title.pack(pady = (h-h*.118)*.025)
